...
impl<'a> Builder<'a> {
    ...
    pub fn branch<T>(mut self, block: &BlockHandle<T>, args: &[Instruction]) -> BlockHandle<True> {
...
impl<'a> IfBuilder<'a, True> {
    ...
    pub fn branch<T>(self, block: &BlockHandle<T>, args: &[Instruction]) -> BlockHandle<True> {
